...
{
    public partial class Ciencias3 : Form
    {
        ...
        private void guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    nota2.Text = "";
                    nota3.Text = "";
                    cn.CargarNotasCiencias3(dgvciencias3);
        ...
        private void Ciencias3_Load(object sender, EventArgs e)
        {
            conexion.Open();
            cn.CargarAlumnos3(AlumnosTercero);
        ...
        private void dgvmate2_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow fila = dgvciencias3.Rows[e.RowIndex];
