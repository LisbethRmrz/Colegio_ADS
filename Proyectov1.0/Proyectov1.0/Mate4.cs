...
{
    public partial class Mate4 : Form
    {
        ...
        private void Mate4_Load(object sender, EventArgs e)
        {
            conexion.Open();
            cn.CargarAlumnos4(AlumnosCuarto);

            cn.CargarNotasMatematicas4(dgvmate4);
        ...
        private void dgvmate4_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow fila = dgvmate4.Rows[e.RowIndex];
