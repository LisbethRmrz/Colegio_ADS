...
{
    public partial class Ciencias6 : Form
    {
        ...
        private void Ciencias6_Load(object sender, EventArgs e)
        {
            conexion.Open();
            cn.CargarAlumnos6(AlumnosSexto);

            cn.CargarNotasCiencias6(dgvciencias6);
        ...
        private void dgvciencias6_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow fila = dgvciencias6.Rows[e.RowIndex];
