...
{
    public partial class Mate6 : Form
    {
        ...
        private void Mate6_Load(object sender, EventArgs e)
        {
            conexion.Open();
            cn.CargarAlumnos6(AlumnosSexto);

            cn.CargarNotasMatematicas6(dgvmate6);
        ...
        private void dgvmate6_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow fila = dgvmate6.Rows[e.RowIndex];
        ...
        private void eliminar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    cn.CargarNotasMatematicas2(dgvmate6);
                    txtestudiante.Text = "";
                    nota1.Text = "";
                    nota2.Text = "";
                    nota3.Text = "";
