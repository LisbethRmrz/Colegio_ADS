...
{
    public partial class Lenguaje2 : Form
    {
        ...
        private void Lenguaje2_Load(object sender, EventArgs e)
        {
            conexion.Open();
            cn.CargarAlumnosSegundo(AlumnosSegundo);

            cn.CargarNotasLenguaje2(dgvlenguaje2);
        ...
        private void dgvlenguaje2_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow fila = dgvlenguaje2.Rows[e.RowIndex];
