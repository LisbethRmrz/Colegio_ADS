...
{
    public partial class Ciencias1 : Form
    {
        ...
        private void Ciencias1_Load(object sender, EventArgs e)
        {
            conexion.Open();

            cn.CargarAlumnos(AlumnosPrimero);

            cn.CargarNotasCiencias(dgvciencias1);
        ...
        private void dgvciencias1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow fila = dgvciencias1.Rows[e.RowIndex];
