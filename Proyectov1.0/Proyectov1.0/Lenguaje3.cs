...
{
    public partial class Lenguaje3 : Form
    {
        ...
        private void Lenguaje3_Load(object sender, EventArgs e)
        {
            conexion.Open();
            cn.CargarAlumnos3(AlumnosTercero);

            cn.CargarNotasLenguaje3(dgvlenguaje3);
        ...
        private void dgvlenguaje3_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow fila = dgvlenguaje3.Rows[e.RowIndex];
