...
{
    public partial class Ciencias2 : Form
    {
        ...
        public Ciencias2()
        {
            ...
            cn.CargarAlumnosSegundo(AlumnosSegundo);
        }

        private void Ciencias2_Load(object sender, EventArgs e)
        {
            conexion.Open();
            cn.CargarAlumnosSegundo(AlumnosSegundo);

            cn.CargarNotasCiencias2(dgvciencias2);
        ...
        private void guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    insert1.Parameters["@IdGrados"].Value = "SG1902";
        ...
        private void AlumnosSegundo_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow fila = AlumnosSegundo.Rows[e.RowIndex];
            txtestudiante.Text = Convert.ToString(fila.Cells[1].Value);
        }

        private void dgvciencias2_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow fila = dgvciencias2.Rows[e.RowIndex];
