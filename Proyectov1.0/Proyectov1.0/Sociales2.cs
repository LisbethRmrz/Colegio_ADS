...
{
    public partial class Sociales2 : Form
    {
        ...
        private void Sociales2_Load(object sender, EventArgs e)
        {
            conexion.Open();
            cn.CargarAlumnosSegundo(AlumnosSegundo);

            cn.CargarNotasSociales2(dgvsociales2);
        ...
        private void dgvsociales2_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow fila = dgvsociales2.Rows[e.RowIndex];
