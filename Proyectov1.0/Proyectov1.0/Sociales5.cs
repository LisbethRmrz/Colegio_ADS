...
{
    public partial class Sociales5 : Form
    {
        ...
        private void Sociales5_Load(object sender, EventArgs e)
        {
            conexion.Open();
            cn.CargarAlumnos5(AlumnosQuinto);

            cn.CargarNotasSociales5(dgvsociales5);
        ...
        private void dgvsociales5_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow fila = dgvsociales5.Rows[e.RowIndex];
