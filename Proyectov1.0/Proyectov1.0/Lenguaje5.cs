...
{
    public partial class Lenguaje5 : Form
    {
        ...
        private void Lenguaje5_Load(object sender, EventArgs e)
        {
            conexion.Open();
            cn.CargarAlumnos5(AlumnosQuinto);

            cn.CargarNotasLenguaje5(dgvlenguaje5);
        ...
        private void dgvlenguaje5_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow fila = dgvlenguaje5.Rows[e.RowIndex];
