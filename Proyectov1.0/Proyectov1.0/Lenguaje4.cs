...
{
    public partial class Lenguaje4 : Form
    {
        ...
        private void Lenguaje4_Load(object sender, EventArgs e)
        {
            conexion.Open();
            cn.CargarAlumnos4(AlumnosCuarto);

            cn.CargarNotasLenguaje4(dgvlenguaje4);
        ...
        private void dgvlenguaje4_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow fila = dgvlenguaje4.Rows[e.RowIndex];
