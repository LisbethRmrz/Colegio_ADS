...
{
    public partial class Ciencias4 : Form
    {
        ...
        private void Ciencias4_Load(object sender, EventArgs e)
        {
            conexion.Open();
            cn.CargarAlumnos4(AlumnosCuarto);

            cn.CargarNotasCiencias4(dgvciencias4);
        ...
        private void dgvciencias4_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow fila = dgvciencias4.Rows[e.RowIndex];
