...
{
    public partial class Sociales4 : Form
    {
        ...
        public Sociales4()
        {
            ...
            cn.CargarAlumnos4(AlumnosCuarto);
        }

        private void Sociales4_Load(object sender, EventArgs e)
        {
            conexion.Open();
            cn.CargarAlumnos4(AlumnosCuarto);

            cn.CargarNotasSociales4(dgvsociales4);
        ...
        private void guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    insert1.Parameters["@IdGrados"].Value = "CG1904";
        ...
        private void AlumnosCuarto_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow fila = AlumnosCuarto.Rows[e.RowIndex];
            txtestudiante.Text = Convert.ToString(fila.Cells[1].Value);
        }

        private void dgvsociales4_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow fila = dgvsociales4.Rows[e.RowIndex];
