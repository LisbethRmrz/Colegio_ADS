...
{
    public partial class Sociales6 : Form
    {
        ...
        private void Sociales6_Load(object sender, EventArgs e)
        {
            conexion.Open();
            cn.CargarAlumnos6(AlumnosSexto);

            cn.CargarNotasSociales6(dgvsociales6);
        ...
        private void dgvsociales6_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow fila = dgvsociales6.Rows[e.RowIndex];
