...
{
    public partial class Sociales3 : Form
    {
        ...
        private void Sociales3_Load(object sender, EventArgs e)
        {
            conexion.Open();
            cn.CargarAlumnos3(AlumnosTercero);

            cn.CargarNotasSociales3(dgvsociales3);
        ...
        private void dgvsociales3_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow fila = dgvsociales3.Rows[e.RowIndex];
