...
{
    public partial class Mate5 : Form
    {
        ...
        private void Mate5_Load(object sender, EventArgs e)
        {
            conexion.Open();
            cn.CargarAlumnos5(AlumnosQuinto);

            cn.CargarNotasMatematicas5(dgvmate5);
        ...
        private void dgvmate5_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow fila = dgvmate5.Rows[e.RowIndex];
