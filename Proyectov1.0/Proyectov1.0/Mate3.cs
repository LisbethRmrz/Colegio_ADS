...
{
    public partial class Mate3 : Form
    {
        ...
        public Mate3()
        {
            ...
            cn.CargarAlumnosSegundo(AlumnosTercero);
        }

        private void Mate3_Load(object sender, EventArgs e)
        {
            conexion.Open();
            cn.CargarAlumnos3(AlumnosTercero);

            cn.CargarNotasMatematicas3(dgvmate3);
        ...
        private void guardar_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    insert1.Parameters["@IdGrados"].Value = "TG1903";
        ...
        private void AlumnosTercero_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow fila = AlumnosTercero.Rows[e.RowIndex];
            txtestudiante.Text = Convert.ToString(fila.Cells[1].Value);
        }

        private void dgvmate3_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            DataGridViewRow fila = dgvmate3.Rows[e.RowIndex];
